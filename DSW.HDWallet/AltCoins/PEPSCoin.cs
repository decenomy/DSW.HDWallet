...
namespace DSW.HDWallet.AltCoins
{
    ...
    public class PEPSCoin : NetworkSetBase
    {
        public static PEPSCoin Instance { get; } = new PEPSCoin();

        public override string CryptoCode => "PEPS";

        private PEPSCoin()
        {
        }

        public class PEPSCoinConsensusFactory : ConsensusFactory
        {
            private PEPSCoinConsensusFactory()
            {
            }

            public static PEPSCoinConsensusFactory Instance { get; } = new PEPSCoinConsensusFactory();

            public override BlockHeader CreateBlockHeader()
            {
                return new PEPSCoinBlockHeader();
            }

            public override Block CreateBlock()
            {
                return new PEPSCoinBlock(new PEPSCoinBlockHeader());
            }
        }

#pragma warning disable CS0618 // Type or member is obsolete
        public class PEPSCoinBlockHeader : BlockHeader
        {
        ...
        public class PEPSCoinBlock : Block
        {
            public PEPSCoinBlock(PEPSCoinBlockHeader h) : base(h)
            {
            }
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        {
            RegisterDefaultCookiePath("PEPS");
        }
        ...
        protected override NetworkBuilder CreateMainnet()
        {
            ...
            builder.SetConsensus(new Consensus
            {
                ...
                ConsensusFactory = PEPSCoinConsensusFactory.Instance,
                SupportSegwit = false,
                CoinType = 847
            })
                .SetBase58Bytes(Base58Type.PUBKEY_ADDRESS, new byte[] { 55 })
                .SetBase58Bytes(Base58Type.SCRIPT_ADDRESS, new byte[] { 92 })
                .SetBase58Bytes(Base58Type.SECRET_KEY, new byte[] { 117 })
                .SetBase58Bytes(Base58Type.EXT_PUBLIC_KEY, new byte[] { 0x04, 0x2e, 0x21, 0x71 })
                .SetBase58Bytes(Base58Type.EXT_SECRET_KEY, new byte[] { 0x08, 0x25, 0x39, 0x2F })
                .SetBech32(Bech32Type.WITNESS_PUBKEY_ADDRESS, Encoders.Bech32("PEPSCoin"))
                .SetBech32(Bech32Type.WITNESS_SCRIPT_ADDRESS, Encoders.Bech32("PEPSCoin"))
                .SetMagic(0x191643a0)
                .SetPort(15252)
                .SetRPCPort(16262)
                .SetMaxP2PVersion(70920)
                .SetName("PEPSCoin-main")
                .AddAlias("PEPSCoin-mainnet")
                .AddDNSSeeds(new[]
                {
                    new DNSSeedData("seed1", "seed1.peps.today"),
                    new DNSSeedData("seed2", "seed2.peps.today"),
                    new DNSSeedData("seed3", "seed3.peps.today")
                })
        ...
        protected override NetworkBuilder CreateTestnet()
        {
            ...
            builder.SetConsensus(new Consensus
            {
               ...
               .SetBase58Bytes(Base58Type.PUBKEY_ADDRESS, new byte[] { 55 })
                ...
                .SetPort(15252)
                .SetMaxP2PVersion(70920)
                .SetName("PEPSCoin-test")
                .AddAlias("PEPSCoin-testnet")
                .AddSeeds(new NetworkAddress[0])
        ...
        protected override NetworkBuilder CreateRegtest()
        {
            ...
            var res = builder.SetConsensus(new Consensus
            {
               ...
               .SetBase58Bytes(Base58Type.PUBKEY_ADDRESS, new byte[] { 55 })
                ...
                .SetPort(15252)
                .SetMaxP2PVersion(70920)
                .SetName("PEPSCoin-reg")
                .AddAlias("PEPSCoin-regtest")
