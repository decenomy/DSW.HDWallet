...
{
    public class TKyanite : NetworkSetBase
    {
        public static TKyanite Instance { get; } = new TKyanite();

        public override string CryptoCode => "TKYAN";
        public static int Code => 834;
        public static string HexCode => "0x80000342";
        public static string Name => "TKyanite";
